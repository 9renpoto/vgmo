...
Code is written in TypeScript and Preact. Use spaces for indentation, PascalCase for component directories (e.g., `src/Button/Button.tsx`), and provide `ComponentName/index.tsx` entry points. Formatting and linting are handled by Biome (`npx biome ci .`); allow it to manage import order. Stick to Node 20.6+.
